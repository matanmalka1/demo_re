  ...
  return (
    <div className="relative inline-flex items-center" ref={menuRef}>
      ...
      {isOpen && (
        <div
          role="menu"
          className="absolute left-0 top-full mt-1.5 w-48 bg-white dark:bg-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-800 py-1.5 z-30 text-right text-xs divide-y divide-slate-100 dark:divide-slate-800"
        ...
        >
          ...
          <div className="py-1">
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3.5 py-2 text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/50 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
